  ...
  return (
    ...
    <div className="contact-page-wrapper" id="contact-us" data-aos="fade-down">
      ...
      <div className="contact-oz">
        ...
        <a href="https://maps.app.goo.gl/8egLbd2N97EBE5JKA" target="_blanks">
          Kompleks Pertokoan Sunset Indah IIB Blok 5<br/>
          Sunset Road Kuta, Bali 80361</a><br/>
          Ph : <a href = "https://wa.me/628999401012 " target="_blanks">+62 899 940 101 2</a><br/>
          Email: <a href = "mailto: programozbali@gmail.com" target="_blanks">programozbali@gmail.com</a><br/>
          Instagram:
             <a 
              className="text-decoration-none" 
              href="https://www.instagram.com/d_ozradiobali/" target="_blanks">
                @d_ozradiobali
            </a> 
          </p>
        </div>
        ...
        <div className="custom-border"></div>
        <p className="primary-text">
        <a href="https://maps.app.goo.gl/YAeU3hh9Sh1sKrRf7" target="_blanks">
          Jl. Bangka Raya No.5 A, Mampang Prpt.<br/>
          Kota Jakarta Selatan 12720</a><br/>
          Ph : <a href = "https://wa.me/6281210104908 " target="_blanks">+62 812 101 049 08</a> <br/>
          Email: <a href = "mailto: info@ozradiojakarta.com" target="_blanks">info@ozradiojakarta.com</a><br/>
          Instagram:
             <a 
              className="text-decoration-none" 
              href="https://www.instagram.com/ozradiojakarta/" target="_blanks">
                @ozradiojakarta
            </a> 
        </p>
        </div>
      <div className="contact-oz">
        ...
        <div className="custom-border"></div>
        <p className="primary-text">
          <a href="https://maps.app.goo.gl/AnUiRBRNTJNHPY8J7" target="_blanks">
          Jl. Setrasari II No.14, Sukarasa<br/>
          Kota Bandung 40152</a><br/>
          Ph : <a href = "https://wa.me/62817771031 " target="_blanks">+62 817 771 031</a><br/>
          Instagram:
            <a 
              className="text-decoration-none" 
              href="https://www.instagram.com/ozradiobandung/" target="_blanks">
                @ozradiobandung
            </a>
          </p>
        </div>
        ...
        <p className="mt-5 fw-bold fs-3">Advertise With Us</p>
          <div className="custom-border"></div>
          <p className="primary-text">phone: <a href = "https://wa.me/6281214007228 " target="_blanks">+62 812 140 072 28</a><br/>
