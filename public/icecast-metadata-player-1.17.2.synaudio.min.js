...
(self.webpackChunkIcecastMetadataPlayer =
  self.webpackChunkIcecastMetadataPlayer || []).push([
  [496],
  {
    347: (e) => {
      e.exports = Worker;
    ...
    420: (e, g, f) => {
      "use strict";
      f.r(g), f.d(g, { default: () => h });
      const b = (e, g = 4294967295, f = 79764919) => {
          ...
          let r,
            ...
            p = g;
          for (r = 0; r < 256; r++) {
            for (i = r << 24, t = 8; t > 0; --t)
              i = 2147483648 & i ? (i << 1) ^ f : i << 1;
            b[r] = i;
          }
          for (r = 0; r < e.length; r++)
            p = (p << 8) ^ b[255 & ((p >> 24) ^ e[r])];
          return p;
        },
        r = (e, g = b) => {
          const f = (e) =>
              new Uint8Array(e.length / 2).map((g, f) =>
                parseInt(e.substring(2 * f, 2 * (f + 1)), 16)
              ),
            r = (e) => f(e)[0],
            t = new Map();
          [
          ...
          let p,
            ...
            q = 0,
            n = 42,
            O = e.length > 13 && "dynEncode" === e.substring(0, 9),
            c = 0;
          O &&
            ((c = 11),
            (s = r(e.substring(9, c))),
            s <= 1 && ((c += 2), (n = r(e.substring(11, c)))),
            1 === s &&
              ((c += 8),
              (o = ((e) => new DataView(f(e).buffer).getInt32(0, !0))(
                e.substring(13, c)
              ))));
          const u = 256 - n;
          for (let g = c; g < e.length; g++)
            if (((p = e.charCodeAt(g)), 61 !== p || h)) {
              if (92 === p && g < e.length - 5 && O) {
                const f = e.charCodeAt(g + 1);
                (117 !== f && 85 !== f) ||
                  ((p = parseInt(e.substring(g + 2, g + 6), 16)), (g += 5));
              }
              if (p > 255) {
                const e = t.get(p);
                e && (p = e + 127);
          ...
          const x = i.subarray(0, q);
          if (O && 1 === s) {
            const e = g(x);
            if (e !== o) {
              const g = "Decode failed crc32 validation";
              throw (
                (console.error(
                  "`simple-yenc`\n",
                  g + "\n",
      ...
      class o {
        constructor(e = {}) {
          (this.t =
            e.correlationSampleSize > 0 ? e.correlationSampleSize : 11025),
            (this.i = e.initialGranularity > 0 ? e.initialGranularity : 16),
            (this.p =
              e.correlationThreshold >= 0 ? e.correlationThreshold : 0.5),
            (this.o = i.get(o)),
            this.o ||
              ((this.o = (async () =>
                ...
                e ? WebAssembly.compile(r(p)) : WebAssembly.compile(r(s))
              )),
              i.set(this.o)),
            (this.SynAudioWorker = function e(g, f, b) {
              (this.h = new Map()),
                (this.q = (e, g) =>
                  Math.min(e.samplesDecoded, g.samplesDecoded, this.t)),
                (this.O = (e, g) =>
                  Math.min(e.samplesDecoded, g.samplesDecoded, this.i)),
                (this.u = (e, g, f) => {
                  const b = g.BYTES_PER_ELEMENT;
                  let r = f / b;
                  for (let t = 0; t < e.length; t++)
                    (f += e[t].length * b), g.set(e[t], r), (r += e[t].length);
                  return f;
                }),
                (this.j = (g, f) => {
                  let b = this.h.get(g);
                  if (!b) {
                    let f,
                      r = "text/javascript",
                      t = `'use strict';(${((e, g, f, b) => {
                        self.onmessage = (r) => {
                          new e(Promise.resolve(r.data.module), f, b).l
                            .get(g)
                            .apply(null, r.data.params)
                            .then((e) => {
                              self.postMessage(e);
                            });
                        };
                      }).toString()})(${e.toString()}, "${g}", ${this.t}, ${
                        this.i
                      })`;
                    try {
                      f = void 0 !== process.versions.node;
                    } catch {}
                    (b = f
                      ? `data:${r};base64,${Buffer.from(t).toString("base64")}`
                      : URL.createObjectURL(new Blob([t], { type: r }))),
                      this.h.set(g, b);
                  }
                  const r = new (globalThis.Worker || t)(b, {
                      name: "SynAudio",
                    }),
                    i = new Promise((e) => {
                      r.onmessage = (g) => {
                        r.terminate(), e(g.data);
                      };
                    });
                  return (
                    this.o.then((e) => {
                      r.postMessage({ module: e, params: f });
                    }),
                    i
                  );
                }),
                (this.m = (e, g) => {
                  const f = Float32Array.BYTES_PER_ELEMENT,
                    ...
                    t = new WebAssembly.Memory({
                      initial:
                        ((e.samplesDecoded * e.channelData.length +
                          g.samplesDecoded * g.channelData.length) *
                          f) /
                          65536 +
                        4,
                    });
                  return this.o
                    .then((e) =>
                      WebAssembly.instantiate(e, { env: { memory: t } })
                    )
                    .then(({ exports: i }) => {
                      const p = new Map(Object.entries(i)),
                        s = p.get("correlate"),
                        o = new Float32Array(t.buffer),
                        h = new DataView(t.buffer),
                        q = p.get("__heap_base").value,
                        n = this.u(e.channelData, o, q),
                        O = this.u(g.channelData, o, n),
                        c = O + f;
                      s(
                        q,
                        e.samplesDecoded,
                      ...
                      return {
                        correlation: h.getFloat32(O, !0),
                        sampleOffset: h.getInt32(c, !0),
                      };
                    });
                }),
                (this.N = (e, g, f) => {
                  const b = [],
                    ...
                    t = this.q(e, g),
                    i =
                      (Math.log(e.samplesDecoded * t) / Math.log(this.i + 1)) *
                      Math.log(t / 1e4 + 1);
                  f = Math.max(
                    Math.round(Math.min(f, i, e.samplesDecoded / t / 4)),
                    1
                  );
                  const p = Math.ceil(e.samplesDecoded / f);
                  let s = 0;
                  for (let i = 0; i < f; i++) {
                    const f = { channelData: [] };
                    for (let g = 0; g < e.channelData.length; g++) {
                      const b = e.channelData[g].subarray(s, s + p + t);
                      f.channelData.push(b), (f.samplesDecoded = b.length);
                    }
                    (s += p - t), r.push(s), b.push(this.I(f, g));
                  }
                  return Promise.all(b).then((e) => {
                    let g = 0,
                      f = -1;
                    for (let b = 0; b < e.length; b++)
                      e[b].correlation > f && ((g = b), (f = e[b].correlation));
                    return {
                      correlation: e[g].correlation,
                      sampleOffset: e[g].sampleOffset + r[g],
                    };
                  });
                }),
                (this.I = (e, g) => this.j("_sync", [e, g])),
                (this.k = (e, g, f) =>
                  globalThis.Worker
                    ? this.j("_syncWorkerConcurrent", [e, g, f])
                    : this.N(e, g, f)),
                (this.l = new Map([
                  ["_sync", this.m],
                  ["_syncWorker", this.I],
                  ["_syncWorkerConcurrent", this.N],
                ])),
                (this.o = g),
                (this.t = f),
                (this.i = b);
            }),
            (this.v = new this.SynAudioWorker(this.o, this.t, this.i));
        }
        async syncWorkerConcurrent(e, g, f) {
          return this.v.k(e, g, f >= 1 ? f : 1);
        }
        async syncWorker(e, g) {
          return this.v.I(e, g);
        }
        async sync(e, g) {
          return this.v.m(e, g);
        }
        async syncMultiple(e, g) {
          g = g >= 1 ? g : 8;
          const f = [],
            b = [];
          let r = () => {},
            t = Promise.resolve(),
            i = 0;
          for (let g = 0; g < e.length; g++) b.push({ vertex: {} });
          for (let p = 0; p < e.length; p++) {
            const s = e[p],
              o = b[p].vertex;
            (o.name = s.name),
              (o.samplesDecoded = s.data.samplesDecoded),
              (o.edges = new Set());
            for (let h = 0; h < e.length; h++) {
              ...
              i++,
                f.push(
                  this.syncWorker(s.data, q.data).then((e) => {
                    e.correlation > this.p &&
                      o.edges.add({
                        parent: o,
                        vertex: n.vertex,
                        samplesDecoded: q.data.samplesDecoded,
                        ...e,
                      }),
                      i--,
                      r();
          ...
          const p = (e, g) =>
              e.parent &&
              g.parent &&
              e.parent.samplesDecoded !== g.parent.samplesDecoded
                ? e.parent.samplesDecoded > g.parent.samplesDecoded
                : e.correlation !== g.correlation
                ? e.correlation > g.correlation
                : e.sampleOffset !== g.sampleOffset
                ? e.sampleOffset > g.sampleOffset
                : e.vertex &&
                  g.vertex &&
                  e.vertex.name.localeCompare(g.vertex.name) < 0,
            s = new Map(),
            o = new Set(),
            h = (e) => {
              for (const g of e.edges.values()) {
                ...
                if (f) {
                  let e, g;
                  p(f, b) ? ((e = f), (g = b)) : ((e = b), (g = f)),
                    g.cycleWith || ((g.cycleWith = new Set()), o.add(g)),
                    g.cycleWith.add(e),
                    e.cycleWith && e.cycleWith.delete(g);
                }
                s.delete(e);
              }
            };
          for (const { vertex: e } of b) h(e);
          for (const e of o) e.cycleWith.size && e.parent.edges.delete(e);
          const q = new Set();
          for (const e of b) q.add(e.vertex);
          for (const e of b) for (const g of e.vertex.edges) q.delete(g.vertex);
          const n = (e, g, f, b = 0) => {
              for (const r of f)
                (e.has(r.vertex) && p(e.get(r.vertex), r)) ||
                  e.set(r.vertex, {
                    name: r.vertex.name,
                    correlation: r.correlation,
                    sampleOffset: b + r.sampleOffset,
                  }),
                  n(e, g, r.vertex.edges, b + r.sampleOffset);
            },
            O = [];
          for (const e of q) {
            const g = new Map();
            g.set(e, { name: e.name, sampleOffset: 0 }),
              n(g, e, e.edges),
              O.push(
                [...g.values()].sort(
                  (e, g) =>
                    e.sampleOffset - g.sampleOffset ||
                    (e.correlation || 0) - (g.correlation || 0) ||
                    g.name.localeCompare(e.name)
                )
              );
          }
          return O;
...
//# sourceMappingURL=icecast-metadata-player-1.17.2.synaudio.min.js.map
